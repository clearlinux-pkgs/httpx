...
Source0  : https://files.pythonhosted.org/packages/ba/a5/e6a09b863d61ef99dc5dc70ae3102f0e382195e69625bc428908b7c246b0/httpx-0.21.0.tar.gz
...
%prep
%setup -q -n httpx-0.21.0
cd %{_builddir}/httpx-0.21.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1636991854
...
cp %{_builddir}/httpx-0.21.0/LICENSE.md %{buildroot}/usr/share/package-licenses/httpx/2f9a422e6ae22185bd3e9cdaec727ac95ab47bbb
