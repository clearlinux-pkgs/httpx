...
Source0  : https://files.pythonhosted.org/packages/91/e3/290e3a3729cf92ed39d1bee594e698f99bbb7f9b0a041282c987a6376d66/httpx-0.18.1.tar.gz
...
%prep
%setup -q -n httpx-0.18.1
cd %{_builddir}/httpx-0.18.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1619735999
...
cp %{_builddir}/httpx-0.18.1/LICENSE.md %{buildroot}/usr/share/package-licenses/httpx/2f9a422e6ae22185bd3e9cdaec727ac95ab47bbb
